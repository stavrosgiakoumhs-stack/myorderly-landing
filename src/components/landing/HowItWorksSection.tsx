...
export function HowItWorksSection() {
  return (
    <section
      id="how-it-works"
      className="scroll-mt-20 border-b border-slate-200/80 bg-slate-50 py-16 sm:py-20 lg:py-24"
        ...
        <ol className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {howSteps.map((step) => (
            <li key={step.step} className="relative">
              <div className="relative flex h-full flex-col rounded-2xl border border-slate-200/80 bg-white p-6 text-center shadow-sm transition hover:border-orderly-blue/25 hover:shadow-md lg:text-left">
